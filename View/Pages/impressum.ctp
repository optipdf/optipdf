...
<div class="grid-container">
    ...
    <h2>Kontakt:</h2>
    <p>Telefon: 061517871427</p>
    <p>E-Mail:</p>
    <p>info[ätt]optipdf.de</p>
    ...
    <p>Unser Angebot enthält Links zu externen Webseiten Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb können wir für diese fremden Inhalte auch keine Gewähr übernehmen.
        ...
        Die verlinkten Seiten wurden zum Zeitpunkt der Verlinkung auf mögliche Rechtsverstöe überprüft.
    ...
    <p>Diese Website benutzt Google Analytics, einen Webanalysedienst der Google Inc. („Google“).
        ...
        Sie können die Erfassung durch Google Analytics verhindern, indem Sie auf folgenden Link klicken.<a href="javascript:gaOptout()">Google Analytics deaktivieren</a>
        Es wird ein Opt-Out-Cookie gesetzt(weitere Informationen zu finden unter http://www.google.com/ads/preferences/html/opt-out.html), der die zukünftige Erfassung Ihrer Daten beim Besuch dieser Website verhindert:
        Nähere Informationen zu Nutzungsbedingungen und Datenschutz finden Sie unter http://www.google.com/analytics/terms/de.html bzw. unter http://www.google.com/intl/de/analytics/privacyoverview.html.
        Auf dieser Website wurde Google Analytics um den Code „ga('set', 'anonymizeIp', true);“ erweitert um eine anonymisierte Erfassung von IP-Adressen (sog. IP-Masking) zu gewährleisten.</p>
</div>
